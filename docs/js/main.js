!(function (t) {
        ...
        (t.exports = function (t, n, r, a) {
          ...
          x
            ? ((v = r(function (t, r, e, o) {
                ...
                if (w(r)) {
                  if (
                    ...
                    return xt in r ? Ft(v, r) : Mt.call(v, r);
                  (i = r), (p = Et(e, n));
                  var g = r.byteLength;
                  if (void 0 === o) {
            ...
            : (i(function () {
              ...
              $(m !== Function.prototype ? P(g).concat(P(m)) : P(g), function (
                t
              ) {
                t in v || h(v, t, g[t]);
              }),
    ...
    ((n = t.exports = function (t, n, r, l, h) {
      ...
      if (i(g)) {
        for (p = c(t.length); p > x; x++)
          if ((y = n ? m(u((v = t[x]))[0], v[1]) : m(t[x])) === f || y === s)
            return y;
      } else
  ...
  function (t, n, r) {
    ...
    t.exports = function (t, n, r, d, y, g) {
      ...
      if (
        ...
        (x = d.getConstructor(n, t, y, b)), u(x.prototype, r), (c.NEED = !0);
      return (
        p(x, t),
        (S[t] = x),
        o(o.G + o.W + o.F * (x != m), S),
  ...
  function (t, n, r) {
    ...
    function V(t, n, r, e, o, i) {
      ...
      for (var c = t[j]._b, a = u + t[T], f = e(+o), s = 0; s < n; s++)
        c[a + s] = f[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
  ...
  function (t, n, r) {
    ...
    r(132);
    var e,
      o = (e = r(304)) && e.__esModule ? e : { default: e };
    ...
    t.exports = function (t) {
      return new Promise(function (n, s) {
        ...
        if (
          ...
          var g = r(332),
            m =
              (t.withCredentials || a(y)) && t.xsrfCookieName
  ...
  function (t, n, r) {
    ...
    var e = r(1),
      ...
      Z = function (t, n) {
        if (((t = w(t)), (n = S(n, !0)), t !== V || !o(B, n) || o(W, n))) {
          var r = M(t, n);
          return (
            !r || !o(B, n) || (o(t, k) && t[k][n]) || (r.enumerable = !0), r
          );
        }
      },
      Q = function (t) {
        for (var n, r = N(w(t)), e = [], i = 0; r.length > i; )
          o(B, (n = r[i++])) || n == k || n == a || e.push(n);
        return e;
      },
      tt = function (t) {
        for (
          var n, r = t === V, e = N(r ? W : w(t)), i = [], u = 0;
          e.length > u;

        )
          !o(B, (n = e[u++])) || (r && !o(V, n)) || i.push(B[n]);
        return i;
      };
    G ||
      (c(
        (I = function () {
          ...
          return i && z && H(V, t, { configurable: !0, set: n }), X(t);
        }).prototype,
        "toString",
        function () {
          return this._k;
      ...
      (r(46).f = K),
      (A.f = tt),
      i && !r(31) && c(V, "propertyIsEnumerable", K, !0),
      (v.f = function (t) {
        return X(p(t));
      })),
    ...
    for (
      ...
      p(nt[rt++]);
    for (var et = j(p.store), ot = 0; et.length > ot; ) d(et[ot++]);
    u(u.S + u.F * !G, "Symbol", {
      for: function (t) {
    ...
    u(u.S + u.F * it, "Object", {
      ...
      I.prototype[C] || r(15)(I.prototype, C, I.prototype.valueOf),
      l(I, "Symbol"),
      l(Math, "Math", !0),
      l(e.JSON, "JSON", !0);
  },
        ...
        function (t, n) {
          ...
          for (var b, w = "", S = 0, _ = 0; _ < m.length; _++) {
            ...
            for (
              ...
              P.push(void 0 === (b = x[A]) ? b : String(b));
            var F = x.groups;
            if (p) {
  ...
  function (t, n, r) {
    r(277), (t.exports = r(7).Array.includes);
  },
  function (t, n, r) {
    "use strict";
    var e = r(0),
  ...
  function (t, n, r) {
    r(279), (t.exports = r(7).Array.flatMap);
  },
  function (t, n, r) {
    "use strict";
    var e = r(0),
  ...
  function (t, n, r) {
    r(282), (t.exports = r(7).String.padStart);
  },
  function (t, n, r) {
    "use strict";
    var e = r(0),
  ...
  function (t, n, r) {
    r(284), (t.exports = r(7).String.padEnd);
  },
  function (t, n, r) {
    "use strict";
    var e = r(0),
  ...
  function (t, n, r) {
    r(286), (t.exports = r(7).String.trimLeft);
  },
  function (t, n, r) {
    "use strict";
    r(40)(
  ...
  function (t, n, r) {
    r(288), (t.exports = r(7).String.trimRight);
  },
  function (t, n, r) {
    "use strict";
    r(40)(
  ...
  function (t, n, r) {
    r(290), (t.exports = r(62).f("asyncIterator"));
  },
  function (t, n, r) {
    r(91)("asyncIterator");
  },
  function (t, n, r) {
    r(292), (t.exports = r(7).Object.getOwnPropertyDescriptors);
  },
  function (t, n, r) {
    var e = r(0),
      o = r(118),
  ...
  function (t, n, r) {
    r(294), (t.exports = r(7).Object.values);
  },
  function (t, n, r) {
    var e = r(0),
      o = r(120)(!1);
  ...
  function (t, n, r) {
    r(296), (t.exports = r(7).Object.entries);
  },
  function (t, n, r) {
    var e = r(0),
      o = r(120)(!0);
  ...
  function (t, n, r) {
    "use strict";
    r(112), r(298), (t.exports = r(7).Promise.finally);
  },
  function (t, n, r) {
    "use strict";
    var e = r(0),
  ...
  function (t, n, r) {
    r(300), r(301), r(302), (t.exports = r(7));
  },
  function (t, n, r) {
    var e = r(1),
      o = r(0),
  ...
  function (t, n, r) {
    t.exports =
      ...
      !r(122)(function () {
        return (
          7 !=
          Object.defineProperty(r(313)("div"), "a", {
            get: function () {
              return 7;
            },
          }).a
    ...
    t.exports = function (t) {
      return (
        ...
        (t.adapter || u.adapter)(t).then(
          function (n) {
            return (
              c(t), (n.data = o(n.data, n.headers, t.transformResponse)), n
            );
          },
          function (n) {
            return (
  ...
  function (t, n, r) {
                      ...
                      switch ((t.prev = t.next)) {
                        ...
                        case 3:
                          return (
                            ...
                            t.abrupt("return", this.result)
                          );
                        case 8:
                          (t.prev = 8),
                            (t.t0 = t.catch(0)),
                            alert("Асуудал гарлаа : " + t.t0);
                        case 11:
                        case "end":
                          return t.stop();
                      }
    ...
    r(89),
      new c("pasta").doSearch().then(function (t) {
